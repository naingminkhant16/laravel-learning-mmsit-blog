        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @trash
                    <form action="{{ route('post.destroy',[$post->id,'delete'=>'restore']) }}" class="d-inline-block"
                        method="post">
                        @csrf
                        @method('delete')
                    ...
                    <form action="{{ route('post.destroy',[$post->id,'delete'=>'force']) }}" class="d-inline-block"
                        method="post">
                        @csrf
                        @method('delete')
                        <button class="btn btn-sm btn-outline-dark">
                    ...
                    <form action="{{ route('post.destroy',[$post->id,'delete'=>'soft']) }}" class="d-inline-block"
                        method="post">
                        @csrf
                        @method('delete')
                        <button class="btn btn-sm btn-outline-dark">
